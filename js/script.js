    ...
    if (!settingsSaved) {
        submitButton.classList.add('disabled-button');
            ...
            document.getElementById('exclude-button').addEventListener('click', function() {
              ...
              // Clear animation on all button clicks
             ['clear-button', 'submit-button', 'settings-button', 'populate-matrix-button', 'randomize-matrix-button', 'exclude-button'].forEach(function(buttonId) {
